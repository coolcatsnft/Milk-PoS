...
interface RootMintableERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class RootMintableERC20 extends BaseContract {
  ...
  interface: RootMintableERC20Interface;
